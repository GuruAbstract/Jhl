        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="<?php echo base_url('website/index'); ?>"><img src="<?php echo base_url("assets/img/logo.png"); ?>" class="img-responsive" style="width: 140px; margin-top: -16px;"></a>
            </div>
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                ?>
                  <li class=""><a href="#"><?php echo $this->session->userdata('FNAME')." ".$this->session->userdata('LNAME'); ?></a></li>
                <?php  
                    }
                    else if($this->session->userdata('HNAME')){
                ?>
                    <li class=""><a href="#"><?php echo $this->session->userdata('HNAME'); ?></a></li>
                <?php
                    }
                    else {
                ?>

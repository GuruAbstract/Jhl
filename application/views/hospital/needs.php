    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Our requirements</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <?php
                ...
                ?>
                <div class="row">
                    <div class="col-md-6"><b>ITEM NAME</b></div>
                ...
                <div class="row">
                    ...
                    ?>
                    <div class="col-md-6"><?php echo $row->INAME; ?></div>
                    <div class="col-md-6"><?php echo $row->QUANTITY; ?></div>
                    <?php 
                        }
                    ?>
                </div>
                <?php
                    ...
                    ?>
                        <div class="col-md-12">We don't have any requirements</div>            
                    <?php
                        }      
                ?>
            </div>
